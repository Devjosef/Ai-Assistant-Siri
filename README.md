...
Endpoint: /create-notion-template
...
Tap Add Action.
Search for Web and select Get Contents of URL.
...
Tap Add to Siri.
Record a custom phrase that will trigger this shortcut.
Test Your Shortcut:
...
4. Make Changes:
   Implement your changes or fixes. Write clear commit messages.


5. Test Your Changes:
   Ensure your changes work and pass all tests.
...
7. Create a Pull Request:
   Open a pull request in the original repository and describe 
   your changes.
